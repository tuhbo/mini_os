img=/home/tuhb/os/bochs/hd30M.img
...
image:
	@-rm -rf $(img)
	../bin/bximage -hd -mode="flat" -size=30 -q $(img)
...
clean:
	@-rm -rf $(BUILD_DIR)
	@-rm -rf fs/*.img fs/*.bin fs/*.o fs/*~	
	@-rm -rf userprog/*.img userprog/*.bin userprog/*.o userprog/*~
	@-rm -rf device/*.img device/*.bin device/*.o device/*~
	...
	@-rm -rf shell/*.img shell/*.bin shell/*.o shell/*~
	@-rm -rf thread/*.img thread/*.bin thread/*.o thread/*~
